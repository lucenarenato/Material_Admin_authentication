  ...
  <div class="container-fluid logs-container">
    <div class="row">
      ...
      <div class="col-sm-9 col-md-10 table-container">
        ...
        <div>
          <?php if($current_file): ?>
            <a href="?dl=<?php echo e(base64_encode($current_file)); ?>"><span class="glyphicon glyphicon-download-alt"></span> Download file</a>
            -
            <a id="delete-log" data-toggle="modal" data-target="#confirmDelete" data-href="?del=<?php echo e(base64_encode($current_file)); ?>" data-title="Delete Log File" data-message="Are you sure you want to delete log file?"><span class="glyphicon glyphicon-trash"></span> Delete file</a>
