<ul class="social-list">
    <li>
        <a href="<?php echo e(route('social.redirect', ['provider' => 'twitter'])); ?>" class="social-twitter" id="twitter">
    ...
    <li>
        <a href="<?php echo e(route('social.redirect', ['provider' => 'facebook'])); ?>" class="social-facebook" id="facebook">
    ...
    <li>
        <a href="<?php echo e(route('social.redirect', ['provider' => 'google'])); ?>" class="social-googleplus" id="googleplus">
    ...
    <li>
        <a href="<?php echo e(route('social.redirect', ['provider' => 'github'])); ?>" class="social-github" id="github">
    ...
    <li>
        <a href="<?php echo e(route('social.redirect', ['provider' => 'youtube'])); ?>" class="social-youtube" id="youtube">
