...
<div class="mdl-grid full-grid margin-top-0 padding-0">
	<div class="mdl-cell mdl-cell mdl-cell--12-col mdl-cell--12-col-phone mdl-cell--8-col-tablet mdl-cell--12-col-desktop mdl-card mdl-shadow--3dp margin-top-0 padding-top-0">
	    <div class="mdl-card card-wide" style="width:100%;" itemscope itemtype="https://schema.org/Person">
			...
			<div class="mdl-card__title mdl-color--primary mdl-color-text--white" <?php if($user->profile->user_profile_bg != NULL): ?> style="background: url('<?php echo e($user->profile->user_profile_bg); ?>') center/cover;" <?php endif; ?>>
						        ...
						        <?php if($user->profile->twitter_username): ?>
									<li class="mdl-list__item">
										<span class="mdl-list__item-primary-content">
											...
											<?php echo HTML::link('https://twitter.com/'.$user->profile->twitter_username, $user->profile->twitter_username, array('class' => 'twitter-link mdl-typography--font-light', 'target' => '_blank')); ?>
						        ...
						        <?php if($user->profile->github_username): ?>
							        <li class="mdl-list__item">
							        	<span class="mdl-list__item-primary-content">
											...
											<?php echo HTML::link('https://github.com/'.$user->profile->github_username, $user->profile->github_username, array('class' => 'github-link mdl-typography--font-light', 'target' => '_blank')); ?>
