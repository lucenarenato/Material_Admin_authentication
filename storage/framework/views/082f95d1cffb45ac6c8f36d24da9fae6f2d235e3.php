<script type="text/javascript">
    ...
    $(document).ready(function() {
      var userLocation = '<?php echo e(Auth::user()->profile->location); ?>' ? '<?php echo e(Auth::user()->profile->location); ?>' : 'Portland, OR, United States';
...
//'mdl-color--grey-700';
    ...
    function location_buttons() {
      ...
      $('.js-user-location').on('click', function() {
          loadWeather('<?php echo e(Auth::user()->profile->location); ?>','');
      });
    }
